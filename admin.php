                ...
                <?php foreach ($pending_proofs as $proof): ?>
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        <a href="uploads/<?php echo htmlspecialchars($proof['image_path']); ?>" target="_blank">
                            <!-- Optimization: Add lazy loading to admin dashboard to prevent eager loading of all proof images -->
                            <img src="uploads/<?php echo htmlspecialchars($proof['image_path']); ?>" alt="Waste Proof Image" class="w-full h-48 object-cover" loading="lazy">
                        </a>
                        <div class="p-4">
